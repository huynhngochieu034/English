...
import { grammar } from '../config/word';
import './unit8.css';

class Practice7 extends Component {
        ...
        return (
            <div className="practice2">
                ...
                <div className="container">
                    <h4 className="justify-content-center">Related Words</h4>
                    ...
                    <ul style={{ marginTop: "20px" }} className="pagination justify-content-center">
                        ...
                        <li className="page-item">
                            <label className="page-link labelLink" onClick={() => this.setList(30, 35)}><u>Bài 6</u></label>
                        </li>
                        <li className="page-item">
                            <label className="page-link labelLink" onClick={() => this.setList(36, 41)}><u>Bài 7</u></label>
                        </li>
                        <li className="page-item">
                            <label className="page-link labelLink" onClick={() => this.setList(42, 47)}><u>Bài 8</u></label>
                        </li>
                        <li className="page-item">
                            <label className="page-link labelLink" onClick={() => this.setList(48, 53)}><u>Bài 9</u></label>
                        </li>
                        <li className="page-item">
                            <label className="page-link labelLink" onClick={() => this.setList(54, 54)}><u>Bài 10</u></label>
                        </li>
                    </ul>
